...
CITIES = [("tbilisi", "Тбилиси"), ("batumi", "Батуми"),
          ("kobuleti", "Кобулети"),
          ("coast", "Побережье Аджарии: Чакви · Цихисдзири · Гонио"),
          ("ozurgeti", "Озургети и Гурия: Уреки · Шекветили · Ланчхути"),
          ("kutaisi", "Кутаиси и Имеретия: Цхалтубо"),
          ("adjara-mtn", "Горная Аджария: Кеда · Шуахеви · Хуло"),
...
MY_CITY = {"tbilisi": [1], "batumi": [15], "kobuleti": [94],
           ...
           "ozurgeti": [67, 237],             # Озургети, Ланчхутский мун.
           "kutaisi": [96, 212],              # Кутаиси, Цхалтубский мун.
           "adjara-mtn": [236, 226, 195],     # Кеда, Шуахеви, Хуло (муниципалитеты)
           "poti": [91], "zugdidi": [39]}
MY_DEAL = {"rent": 2, "sale": 1}
MY_TYPE = {"apt": 1, "house": 2}
SS_CITY = {"tbilisi": [95], "batumi": [96], "kobuleti": [14],
           "coast": [60, 65, 224, 230, 267, 126, 109, 116, 16, 46],  # Чакви, Цихисдзири, Очхамури,
           # Бобоквати, Чаквистави, Махинджаури, Гонио, Квариати, Сарпи, Хелвачаури
           "ozurgeti": [24, 10, 57, 110, 119, 83],  # Озургети, Уреки, Шекветили, Григолети, Ланчхути, Бахмаро
           "kutaisi": [97, 42],               # Кутаиси, Цхалтубо
           "adjara-mtn": [13, 59, 49],        # Кеда, Шуахеви, Хуло
...
NOTE = {
 ...
 ("ozurgeti", "rent"): "Гурия: сам Озургети (райцентр, не курорт, в 30 км от Кобулети) плюс курортная полоса — Уреки с магнитными песками, Шекветили, Григолети, а также Ланчхути и горный Бахмаро. Рынок узкий и сильно сезонный: летом почти всё в посуточной аренде.",
 ("ozurgeti", "sale"): "Гурия. Уреки и Шекветили — курортные новостройки у моря, Озургети и Ланчхути — обычный частный сектор заметно дешевле побережья Аджарии.",
 ("coast", "rent"): "Прибрежная полоса Аджарии от Сарпи до Кобулети: район Чакви (сам Чакви, Цихисдзири, Очхамури, Бобоквати, Чаквистави), Махинджаури под Батуми и южные Гонио, Квариати, Сарпи, плюс Хелвачаури. Дешевле самих городов, предложения не пересекаются с Кобулети и Батуми.",
 ("coast", "sale"): "Посёлки побережья Аджарии. Частный сектор и небольшие новостройки у моря.",
 ("kutaisi", "rent"): "Третий город страны и центр Имеретии, в глубине материка (до моря ~100 км). Не курорт, поэтому рынок круглогодичный и без летнего перекоса — в отличие от побережья. Рядом Цхалтубо с его бальнеологическим фондом и советскими санаториями. Цены заметно ниже Тбилиси.",
 ("kutaisi", "sale"): "Кутаиси и Цхалтубо. Много старого фонда и частного сектора; Цхалтубо активно скупают под реконструкцию санаториев и гостевых домов.",
 ("adjara-mtn", "rent"): "Горные муниципалитеты Аджарии в 40–90 км от Батуми вглубь ущелья Аджарисцкали. Не море: горы, зелень, прохладнее летом. Рынок крошечный и почти без объявлений на порталах — здесь сдают по знакомству, так что пустота в таблице отражает не отсутствие жилья, а отсутствие его в интернете.",
 ("adjara-mtn", "sale"): "Горная Аджария. Частные дома и участки, цены заметно ниже побережья.",
